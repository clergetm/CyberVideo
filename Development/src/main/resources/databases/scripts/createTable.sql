...
DROP TABLE Actors;
DROP TABLE Films;
DROP SEQUENCE supportFilmID_sequence;

CREATE TABLE Films(
    filmID INTEGER GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1,
    title VARCHAR2(200),
    year INTEGER,
    synopsis CLOB,
    directorFirstName VARCHAR2(30),
    directorLastName VARCHAR2(30),
    restrictedAge CHAR(3) CHECK (restrictedAge IN ('M10', 'M12', 'M16', 'M18', 'ALL') ),
    CONSTRAINT filmID_pk PRIMARY KEY (filmID)
);

CREATE TABLE Actors(
    actorID INTEGER GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1,
    actorFirstName VARCHAR2(30),
    actorLastName VARCHAR2(30),
...
CREATE SEQUENCE supportFilmID_sequence;

CREATE TABLE QRCodes(
    QRCodeID INTEGER GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1,
    supportfilmID INTEGER,
    link VARCHAR2(255),
...
CREATE TABLE BluRays(
    blurayID INTEGER GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1,
    supportfilmID INTEGER,
    price FLOAT(3),
    state VARCHAR2(9) CHECK (state IN ('AVAILABLE' ,'RENTED', 'DAMAGED', 'STOLEN') ),
...
CREATE TABLE CreditCards (
    ...
    CONSTRAINT supportCardID_CreditCards_fk FOREIGN KEY (supportCardID) REFERENCES SupportCards(supportCardID)
);
...
CREATE TABLE Subscribers (
    ...
    loginID VARCHAR2(50),
    creditID INTEGER,
    subFirstName VARCHAR2(30),
    subLastName VARCHAR2(30),
    birthDate DATE,
...
CREATE TABLE HistoricCreditCards(
    ...
    creditID INTEGER,
    actionDate DATE,
    action VARCHAR2(15) CHECK( action IN ('STARTRENTAL', 'ENDRENTAL', 'PAYFULLPRICE', 'REFUND') ),
    amount INTEGER,
